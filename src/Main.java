...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Radnik radnik = new RadnikPoDanu("Ivan","Ivanovic","2412997712177", "840-23432525-45", 80,22);
        Radnik radnik1 = new RadnikPoSatu("Aca", "Acic", "1206993712177", "840-32567356-45",15,8,22);
